...
class IncidentsODataTests {
    ...
    void draftIncident() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .post("/odata/v4/ProcessorService/Incidents(ID=" + ID
                        + ",IsActiveEntity=false)/ProcessorService.draftActivate")
                .contentType("application/json")
                .accept("application/json"))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .delete("/odata/v4/ProcessorService/Incidents(ID=" + ID + ",IsActiveEntity=true)"))
     ...
     * Test for custom handler ensuing prevent users from modifying a closed
     * Incident
     */
    ...
    void updateIncident() throws Exception {
        ...
        MvcResult updateResult = mockMvc
                .perform(MockMvcRequestBuilders
                        .patch("/odata/v4/ProcessorService/Incidents(ID=" + ID + ",IsActiveEntity=true)")
        ...
        /**
         * Updating a Closed Incident will throw an error with error message "Can't
         * modify a closed incident"
         */
        mockMvc.perform(
                MockMvcRequestBuilders.patch("/odata/v4/ProcessorService/Incidents(ID=" + ID + ",IsActiveEntity=true)")
